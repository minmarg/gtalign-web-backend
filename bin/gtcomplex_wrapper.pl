...
## Wrapper for conducting GTcomplex search
...
--logfile <logfile> Name of the output log file generated by GTcomplex
                 during a search.
...
unless($cos->{NORUN}) {
    ...
    $cos->ProgressMsg("Searching structures using GTcomplex...\n");

    unless($cos->RunGTcomplex(\$nqueries, \%inputs, \$errmsg, \$hlerrmsg)) { 
